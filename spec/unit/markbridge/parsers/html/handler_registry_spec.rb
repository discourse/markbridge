...
RSpec.describe Markbridge::Parsers::HTML::HandlerRegistry do
  ...
  describe ".default" do
...

    {
      ...
      "h1" => [Markbridge::Parsers::HTML::Handlers::HeadingHandler, Markbridge::AST::Heading],
      "h2" => [Markbridge::Parsers::HTML::Handlers::HeadingHandler, Markbridge::AST::Heading],
      "h3" => [Markbridge::Parsers::HTML::Handlers::HeadingHandler, Markbridge::AST::Heading],
      "h4" => [Markbridge::Parsers::HTML::Handlers::HeadingHandler, Markbridge::AST::Heading],
      "h5" => [Markbridge::Parsers::HTML::Handlers::HeadingHandler, Markbridge::AST::Heading],
      "h6" => [Markbridge::Parsers::HTML::Handlers::HeadingHandler, Markbridge::AST::Heading],
