...
module Markbridge
  module AST
    ...
    # id), +topic_id+ is the topic's id, and +user_id+ is the quoted
    # user's id for sources that attribute quotes by id rather than by
    # name (e.g. phpBB's +user_id+ attribute).
    #
    # @example Basic quote
    #   quote = AST::Quote.new
